...
class Solution:
    ...
    def calculate_death_prob(self, timeknown, cost, reflex, sex, blood, bloodchem1, bloodchem2, temperature, race,
        ...
        labels = ['timeknown', 'cost', 'age', 
                  'blood', 'reflex', 'bloodchem1', 'glucose', 
                  'psych2', 'bloodchem3','totalcost', 
                  'psych4', 'urine', 'bloodchem6', 'information', 
                  'psych6', 'temperature']
        values = [float(x) for x in [timeknown, cost, age, 
                  blood, reflex, bloodchem1, glucose, 
                  psych2, bloodchem3,totalcost, 
                  psych4, urine, bloodchem6, information, 
                  psych6, temperature]]
